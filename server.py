...
def handle_update_write_model(this_client_id, msg):
    state = client_dict[this_client_id]["state"]
...
if __name__ == "__main__":
    ...
    server.connect(broke_name, port=1883, keepalive=3600)
    ...
    print_log(f"server sub to dynamicFL/join of {broke_name}")
